...
is 1, UpdatePipeline::UpdateLaneMetaData->new(lane_meta_data => $lane_metadata, file_meta_data => $file_metadata_paired_changed )->update_required(), 'paired flag changed but we do nothing';
